...
map.getView().fit([8562959.312385, 1124057.532011, 8602128.863058, 1145994.707512], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MUNNAR_ADMINISTRTIVE_DIVISION</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (39 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'GIS TEST MUNNAR ADMINISTRATIVE BOUNDARY';
            }
